        ...
        groups: [
            ...
            },
            {
                ...
                components: [
                    ...
                    src('access', 'Microsoft Access', 'available', 'Read an Access database (.accdb / .mdb): a table, or on Windows a query in Access SQL. Windows reads through the Microsoft Access ODBC driver, Linux and macOS through mdbtools. Text, currency, yes/no and dates keep their types.'),
        ...
        groups: [
            ...
            },
            {
                ...
                components: [
                    ...
                    snk('access', 'Microsoft Access', 'available', 'Write a table into an Access database (.accdb / .mdb), creating the file and the table when missing. Append or overwrite in one transaction; an empty upstream leaves the table alone. Windows only, through the Microsoft Access ODBC driver.'),
